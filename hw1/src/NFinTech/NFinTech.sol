...
contract NFinTech is IERC721 {
    ...
    function setApprovalForAll(address operator, bool approved) external {
        ...
        require(operator != address(0), "Cannot set approval for zero address");
    ...
    function approve(address to, uint256 tokenId) external {
        ...
        require(
            owner == msg.sender || _operatorApproval[owner][msg.sender],
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        ...
        // require(
        //     from == owner ||
        //         _tokenApproval[tokenId] == from ||
        //         isApprovedForAll(owner, from),
        //     "Caller is not owner or approved"
        // );
        require(to != address(0), "Cannot transfer to zero address");
        require(_owner[tokenId] == from, "Transfer from incorrect owner");
